...
import { StyledMenu } from "./DropdownButton";
...
function LandingToolbar(props: LandigToolbarProps) {
  ...
  return (
    <AppBar position="static" sx={{ backgroundImage: "none", backgroundColor: "transparent", boxShadow: "none" }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <BoxIcon sx={{ display: { xs: "none", md: "flex" }, mr: 1 }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          <BoxIcon sx={{ display: { xs: "flex", md: "none" }, mr: 1 }} />
          <Typography
            variant="h5"
            noWrap
            component="a"
          ...
          <Box sx={{ flexGrow: 0 }}>
            <IconButton
              onClick={() => {
                open("https://github.com/DerGoogler/MMRL", "_blank");
              }}
              sx={{ p: 0 }}
            >
              <GitHubIcon />
